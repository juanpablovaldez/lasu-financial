  ...
  return (
    <Card className="mt-6 border-border">
      <CardContent className="flex-row items-center gap-4 py-4">
        <View className="h-12 w-12 items-center justify-center rounded-full bg-muted dark:bg-muted">
        ...
        <View className="flex-1">
          ...
          <Pressable
            ...
            className="mt-1 self-start rounded bg-primary px-4 py-2"
            accessibilityRole="button"
            accessibilityLabel="Contactar soporte"
          >
            <Text className="font-medium text-primary-foreground">Contactar soporte</Text>
          </Pressable>
        </View>
      </CardContent>
    </Card>
